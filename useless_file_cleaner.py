...
class UselessFileCleaner:
    ...
    def setup_ui(self):
        ...
        author_label = tk.Label(top_frame, text=author_text[self.current_lang], fg="blue", cursor="hand2", font=("Arial", 10, "italic"))
        ...
        tk.Label(top_frame, text=instructions[self.current_lang], font=("Arial", 10)).pack(side=tk.LEFT, padx=10)
